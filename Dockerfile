...
# TODO: REMOVE THIS AFTER FIREBASE-BINDINGS ARTIFACTS ARE CHECKED IN SOMEWHERE
# If you're copying this code, you should delete this section.
# ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
WORKDIR /project/firebase-bindings

RUN ./gradlew publishToMavenLocal --no-daemon

# ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
# END REMOVE THIS AFTER FIREBASE-BINDINGS ARTIFACTS ARE CHECKED IN SOMEWHERE
